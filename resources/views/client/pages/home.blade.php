        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex overflow-x-auto pb-5 snap-x snap-mandatory scrollbar-hide gap-4 mb-10">
                ...
                <div class="flex-shrink-0 text-center snap-center min-w-[100px] sm:min-w-[120px]">
                    <img src="{{ asset('uploads/sushi-mon-an-quoc-dan-cua-nguoi-nhat-2_c940b210a8094194b29216c31a3620d0_1024x1024.webp') }}" alt="Sushi" class="w-20 h-20 sm:w-28 sm:h-28 object-cover rounded-full mx-auto mb-2 transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                    <h3 class="text-xs sm:text-sm font-medium text-theme-primary">Sushi</h3>
                </div>
                <div class="flex-shrink-0 text-center snap-center min-w-[100px] sm:min-w-[120px]">
                    <img src="{{ asset('uploads/3740e0c14b97c50890905a1961b9eb542959cc06.avif') }}" alt="Ramen" class="w-20 h-20 sm:w-28 sm:h-28 object-cover rounded-full mx-auto mb-2 transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                    <h3 class="text-xs sm:text-sm font-medium text-theme-primary">Ramen</h3>
                </div>
                <div class="flex-shrink-0 text-center snap-center min-w-[100px] sm:min-w-[120px]">
                    <img src="{{ asset('uploads/tempura.jpg') }}" alt="Tempura" class="w-20 h-20 sm:w-28 sm:h-28 object-cover rounded-full mx-auto mb-2 transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                    <h3 class="text-xs sm:text-sm font-medium text-theme-primary">Tempura</h3>
                </div>
                <div class="flex-shrink-0 text-center snap-center min-w-[100px] sm:min-w-[120px]">
                    <img src="{{ asset('uploads/FUSED-BY-FIONA-UYEMA-FUTO-MAKI-SUSHI.webp') }}" alt="Maki" class="w-20 h-20 sm:w-28 sm:h-28 object-cover rounded-full mx-auto mb-2 transition-all hover:transform hover:-translate-y-1 hover:shadow-lg">
                    <h3 class="text-xs sm:text-sm font-medium text-theme-primary">Maki</h3>
                </div>
            </div>
            ...
            <div class="hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                <div class="card rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all hover:-translate-y-2">
                    <div class="h-44 sm:h-48 bg-cover bg-center relative" style="background-image: url('{{ asset('uploads/sushi-mon-an-quoc-dan-cua-nguoi-nhat-2_c940b210a8094194b29216c31a3620d0_1024x1024.webp') }}')"></div>
                    <div class="p-5">
                        <div class="flex justify-between items-center mb-3">
                            <h3 class="font-semibold text-theme-primary">{{ trans_db('menu_items', 'salmon_sushi_name', false) ?: 'Salmon Sushi' }}</h3>
                            <span class="text-aisuki-red font-bold">{{ setting('currency', '€') }}12.95</span>
                        </div>
                        <p class="text-theme-secondary text-sm mb-4">{{ trans_db('menu_items', 'salmon_sushi_desc', false) ?: 'Fresh Norwegian salmon with traditional vinegar rice' }}</p>
                        <a href="#" class="inline-block bg-aisuki-red text-white py-2 px-4 rounded-full text-sm font-semibold hover:bg-[#c41017] transition-all">{{ trans_db('sections', 'order_now', false) ?: 'Order Now' }}</a>
                    </div>
                </div>
                <div class="card rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all hover:-translate-y-2">
                    <div class="h-44 sm:h-48 bg-cover bg-center relative" style="background-image: url('{{ asset('uploads/california-roll.jpg') }}')"></div>
                    <div class="p-5">
                        <div class="flex justify-between items-center mb-3">
                            <h3 class="font-semibold text-theme-primary">{{ trans_db('menu_items', 'california_roll_name', false) ?: 'California Roll' }}</h3>
                            <span class="text-aisuki-red font-bold">{{ setting('currency', '€') }}10.50</span>
                        </div>
                        <p class="text-theme-secondary text-sm mb-4">{{ trans_db('menu_items', 'california_roll_desc', false) ?: 'Crab stick, avocado, cucumber, salmon roe, seaweed' }}</p>
                        <a href="#" class="inline-block bg-aisuki-red text-white py-2 px-4 rounded-full text-sm font-semibold hover:bg-[#c41017] transition-all">{{ trans_db('sections', 'order_now', false) ?: 'Order Now' }}</a>
                    </div>
                </div>
                <div class="card rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all hover:-translate-y-2">
                    <div class="h-44 sm:h-48 bg-cover bg-center relative" style="background-image: url('{{ asset('uploads/3740e0c14b97c50890905a1961b9eb542959cc06.avif') }}')"></div>
                    <div class="p-5">
                        <div class="flex justify-between items-center mb-3">
                            <h3 class="font-semibold text-theme-primary">{{ trans_db('menu_items', 'tonkotsu_ramen_name', false) ?: 'Tonkotsu Ramen' }}</h3>
                            <span class="text-aisuki-red font-bold">{{ setting('currency', '€') }}14.95</span>
                        </div>
                        <p class="text-theme-secondary text-sm mb-4">{{ trans_db('menu_items', 'tonkotsu_ramen_desc', false) ?: '12-hour pork bone broth, grilled pork, egg, seaweed' }}</p>
                        <a href="#" class="inline-block bg-aisuki-red text-white py-2 px-4 rounded-full text-sm font-semibold hover:bg-[#c41017] transition-all">{{ trans_db('sections', 'order_now', false) ?: 'Order Now' }}</a>
                    </div>
                </div>
                <div class="card rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all hover:-translate-y-2 sm:col-span-2 md:col-span-1">
                    <div class="h-44 sm:h-48 bg-cover bg-center relative" style="background-image: url('{{ asset('uploads/tempura.jpg') }}')"></div>
                    <div class="p-5">
                        <div class="flex justify-between items-center mb-3">
                            <h3 class="font-semibold text-theme-primary">{{ trans_db('menu_items', 'tempura_shrimp_name', false) ?: 'Shrimp Tempura' }}</h3>
                            <span class="text-aisuki-red font-bold">{{ setting('currency', '€') }}12.05</span>
                        </div>
                        <p class="text-theme-secondary text-sm mb-4">{{ trans_db('menu_items', 'tempura_shrimp_desc', false) ?: 'Fresh shrimp in crispy Japanese batter, with special tempura sauce' }}</p>
                        <a href="#" class="inline-block bg-aisuki-red text-white py-2 px-4 rounded-full text-sm font-semibold hover:bg-[#c41017] transition-all">{{ trans_db('sections', 'order_now', false) ?: 'Order Now' }}</a>
                    </div>
                </div>
            </div>
            ...
            <div class="sm:hidden space-y-4">
                <div class="card rounded-lg overflow-hidden shadow-md flex">
                    <div class="w-1/3 bg-cover bg-center" style="background-image: url('{{ asset('uploads/sushi-mon-an-quoc-dan-cua-nguoi-nhat-2_c940b210a8094194b29216c31a3620d0_1024x1024.webp') }}')"></div>
                    <div class="w-2/3 p-3">
                        <div class="flex justify-between items-center mb-1">
                            <h3 class="font-semibold text-sm text-theme-primary">{{ trans_db('menu_items', 'salmon_sushi_name', false) ?: 'Salmon Sushi' }}</h3>
                            <span class="text-aisuki-red font-bold text-sm">{{ setting('currency', '€') }}12.95</span>
                        </div>
                        <p class="text-theme-secondary text-xs mb-2 line-clamp-2">{{ trans_db('menu_items', 'salmon_sushi_desc', false) ?: 'Fresh Norwegian salmon with traditional vinegar rice' }}</p>
                        <a href="#" class="inline-block bg-aisuki-red text-white py-1.5 px-3 rounded-full text-xs font-semibold hover:bg-[#c41017] transition-all">{{ trans_db('sections', 'order_now', false) ?: 'Order Now' }}</a>
                    </div>
                </div>
                <div class="card rounded-lg overflow-hidden shadow-md flex">
                    <div class="w-1/3 bg-cover bg-center" style="background-image: url('{{ asset('uploads/california-roll.jpg') }}')"></div>
                    <div class="w-2/3 p-3">
                        <div class="flex justify-between items-center mb-1">
                            <h3 class="font-semibold text-sm text-theme-primary">{{ trans_db('menu_items', 'california_roll_name', false) ?: 'California Roll' }}</h3>
                            <span class="text-aisuki-red font-bold text-sm">{{ setting('currency', '€') }}10.50</span>
                        </div>
                        <p class="text-theme-secondary text-xs mb-2 line-clamp-2">{{ trans_db('menu_items', 'california_roll_desc', false) ?: 'Crab stick, avocado, cucumber, salmon roe, seaweed' }}</p>
                        <a href="#" class="inline-block bg-aisuki-red text-white py-1.5 px-3 rounded-full text-xs font-semibold hover:bg-[#c41017] transition-all">{{ trans_db('sections', 'order_now', false) ?: 'Order Now' }}</a>
                    </div>
                </div>
                <div class="card rounded-lg overflow-hidden shadow-md flex">
                    <div class="w-1/3 bg-cover bg-center" style="background-image: url('{{ asset('uploads/3740e0c14b97c50890905a1961b9eb542959cc06.avif') }}')"></div>
                    <div class="w-2/3 p-3">
                        <div class="flex justify-between items-center mb-1">
                            <h3 class="font-semibold text-sm text-theme-primary">{{ trans_db('menu_items', 'tonkotsu_ramen_name', false) ?: 'Tonkotsu Ramen' }}</h3>
                            <span class="text-aisuki-red font-bold text-sm">{{ setting('currency', '€') }}14.95</span>
                        </div>
                        <p class="text-theme-secondary text-xs mb-2 line-clamp-2">{{ trans_db('menu_items', 'tonkotsu_ramen_desc', false) ?: '12-hour pork bone broth, grilled pork, egg, seaweed' }}</p>
                        <a href="#" class="inline-block bg-aisuki-red text-white py-1.5 px-3 rounded-full text-xs font-semibold hover:bg-[#c41017] transition-all">{{ trans_db('sections', 'order_now', false) ?: 'Order Now' }}</a>
                    </div>
                </div>
                <div class="card rounded-lg overflow-hidden shadow-md flex">
                    <div class="w-1/3 bg-cover bg-center" style="background-image: url('{{ asset('uploads/tempura.jpg') }}')"></div>
                    <div class="w-2/3 p-3">
                        <div class="flex justify-between items-center mb-1">
                            <h3 class="font-semibold text-sm text-theme-primary">{{ trans_db('menu_items', 'tempura_shrimp_name', false) ?: 'Shrimp Tempura' }}</h3>
                            <span class="text-aisuki-red font-bold text-sm">{{ setting('currency', '€') }}12.05</span>
                        </div>
                        <p class="text-theme-secondary text-xs mb-2 line-clamp-2">{{ trans_db('menu_items', 'tempura_shrimp_desc', false) ?: 'Fresh shrimp in crispy Japanese batter, with special tempura sauce' }}</p>
                        <a href="#" class="inline-block bg-aisuki-red text-white py-1.5 px-3 rounded-full text-xs font-semibold hover:bg-[#c41017] transition-all">{{ trans_db('sections', 'order_now', false) ?: 'Order Now' }}</a>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center mt-10 sm:mt-12">
                <a href="#" class="inline-block bg-aisuki-red text-white py-3 px-6 rounded-full font-semibold hover:bg-[#c41017] transition-all">{{ trans_db('sections', 'view_full_menu', false) ?: 'View Full Menu' }}</a>
            </div>
        </div>
    </section>
